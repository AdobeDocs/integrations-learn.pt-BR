...
# Integração do Creative Cloud e do Workfront
...
+ **Fluxo de trabalho do Creative**: a integração simplifica tarefas, comentários e tempo de logon em aplicativos Creative Cloud.
        ...
        <tr>
            ...
            <td>
                <ul style="margin-top: 0;">
                    <li>Quando os criadores desejam encontrar e atualizar o trabalho atribuído sem sair dos aplicativos da Creative Cloud.</li>
                </ul>
            </td>
            <td>
              <ul style="margin-top: 0;">
