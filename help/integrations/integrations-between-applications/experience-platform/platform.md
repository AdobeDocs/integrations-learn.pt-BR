---
title: Integrar o Adobe [!DNL Experience Platform]  com outros aplicativos da Adobe
description: Saiba como integrar o  [!DNL Experience Platform]  a outros aplicativos da Adobe.
...
# Integrar a experiência [!DNL Platform] a outros aplicativos da Adobe

A Adobe Experience [!DNL Platform] é o sistema mais poderoso, flexível e aberto do mercado para criar e gerenciar soluções completas que impulsionem a experiência do cliente. Muitos novos aplicativos da Adobe foram criados com base na Experiência [!DNL Platform], incluindo:
...
* [com o Audience Manager](../rtcdp/rtcdp-aam.md)
