...
<!--  ROW 2a  -->
<td>Analise os resultados do teste de otimização, incluindo o teste A/B, usando o Adobe [!DNL Target] e gerar relatórios abrangentes por meio do Adobe [!DNL Analytics].</td>
...
<!--  ROW 2b  -->
<tr>
   <td>Enviar dados de segmento do Audience Manager para [!DNL Analytics] para análise, descoberta e otimização mais profundas do público-alvo.</td>
    <td><ul style="margin-top: 0;">
        <li>Enviar dados de segmento de terceiros para [!DNL Analytics] para uma análise mais profunda do usuário.</li>
        <li>Enviar dados do CRM para [!DNL Analytics] para inclusão na análise do usuário.</li>
       </ul></td>
...
<tr>
   <td>Expanda os públicos-alvo para plataformas de personalização e publicidade.</td>
    <td><ul style="margin-top: 0;">
        <li>Usar encaminhamento do lado do servidor para enviar [!DNL Analytics] dados para o Audience Manager para criar segmentos.</li>
       </ul></td>
   <td><a href="../integrations-between-applications/aam/aam-analytics.md" target="_blank" rel="noopener noreferrer">AUDIENCE MANAGER e [!DNL Analytics]</a></td>
 </tr>
...
<!--  ROW 2d  -->
<tr>
   <td>Rastrear, analisar e relatar o engajamento do usuário com formulários digitais usando o AEM Forms e [!DNL Analytics]. </td>
   <td><ul style="margin-top: 0;">
...
<!--  ROW 2e  -->
<tr>
   <td>Rastrear, analisar e relatar a atividade do usuário nos sites da AEM Sites usando o Adobe [!DNL Analytics] para obter relatórios e insights abrangentes.</td>
   <td><ul style="margin-top: 0;">
        <li>Rastrear, analisar e gerar relatórios sobre as métricas principais das páginas do site.</li>
        <li>Uso [!DNL Analytics] relatórios para tomar decisões orientadas por dados para a experiência do usuário e a estratégia de conteúdo.</li>
...
<!--  ROW 2f  -->
<tr>
   <td>Obtenha insights abrangentes sobre o Adobe [!DNL Campaign] enviar campanhas de marketing por email usando métricas de pré-clique e taxas de conversão.</td>
   <td><ul style="margin-top: 0;">
        <li>Rastreie, analise e gere relatórios de métricas de conversão pós-clique para campanhas de email.</li>
        <li>Analisar campanhas para outras dimensões coletadas no [!DNL Analytics].</li>
...
<!--  ROW 2g  -->
<tr>
   <td>Obtenha insights abrangentes sobre o Adobe [!DNL Commerce] armazene o desempenho usando as métricas e dimensões principais selecionadas.</td>
   <td><ul style="margin-top: 0;">
        <li>Insights de dados e relatórios sobre atividades comerciais.</li>
        <li>Obtenha insights abrangentes sobre o Adobe [!DNL Commerce] armazene o desempenho usando as métricas e dimensões principais selecionadas.</li>
       </ul></td>
...
<!--  ROW 2h  -->
<tr>
   <td>Usar Adobe [!DNL Analytics] dados comportamentais no Analysis Workspace na Jornada do cliente [!DNL Analytics].</td>
   <td><ul style="margin-top: 0;">
...
<tr>
  ...
  <td><a href="../integrations-between-applications/rtcdp/rtcdp-cja.md" target="_blank" rel="noopener noreferrer">Jornada do cliente [!DNL Analytics] e dados do cliente em tempo real [!DNL Platform]</a></td>
 </tr>
...
<tr>
   ...
   <td>Rastreie e analise a eficácia de imagens de marketing integrando o AEM Assets e o Adobe [!DNL Analytics].</td>
