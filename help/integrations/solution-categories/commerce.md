...
<thead>
 ...
 <tr>
   ...
   <td><ul style="margin-top: 0;">
          <li>Implantação de loja única no AEM
          <li>Implantação global em várias lojas no AEM</li>
          <li>Implantação de vários sistemas com o AEM</li>
        </ul>
  </td>
   <td>
 ...
 <tr>
   ...
   <td>Avalie as métricas de conversão, pedidos, receita, visita e visitante da loja de comércio do funnel.</td>
